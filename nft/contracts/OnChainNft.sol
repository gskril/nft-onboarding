...
contract OnChainNft is ERC721Enumerable, Ownable {
  ...
  function mint(string memory _minterName) public payable {
  ...
  function buildImage(uint tokenId) public view returns(string memory) {
    ...
    return string(abi.encodePacked(
      ...
      '<svg width="1200" height="1200" xmlns="http://www.w3.org/2000/svg">',
        ...
        '<text x="175" y="764" font-size="26px" fill="#7a7a7a"><tspan xml:space="preserve">',currentMetadata.blockTime,'</tspan></text>',
        '<defs>',
